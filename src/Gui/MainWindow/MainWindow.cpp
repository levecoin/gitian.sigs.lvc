...
#include "Common/ChangePasswordDialog.h"
#include "Common/NewPasswordDialog.h"
#include "Common/KeyDialog.h"
...
const char COMMUNITY_FORUM_URL[] = "https://levecointalk.org";
const char REPORT_ISSUE_URL[] = "https://levecoin.org/contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Levecoin Wallet %1").arg(Settings::instance().getVersion()));
